...
| 9    | `src/components/common/Checkbox/Checkbox.tsx`      | 11.4 | forwardRef×1         |
| 10   | `src/components/common/Input/Input.tsx`            | 10.6 | —                    |
...
| 4    | `src/pages/qna/QnaListPage.tsx`                               | 47.8 | useEffect×3, LOC×268    |
| 5    | `src/components/qna/AnswerForm/AnswerForm.tsx`                | 43.9 | useEffect×2, useState×5 |
| 6    | `src/pages/qna/QnaEditPage.tsx`                               | 40.3 | useEffect×1, LOC×263    |
...
| 순위 | 파일                                                     | 점수 | 키 이슈     |
| ---- | -------------------------------------------------------- | ---- | ----------- |
| 1    | `src/features/chatbot/qna/hooks/useQnaChat.ts`           | 24.1 | useEffect×1 |
| 2    | `src/features/chatbot/hooks/sseStream.ts`                | 19   | —           |
| 3    | `src/features/chatbot/hooks/sendStreamingMessage.ts`     | 16.6 | —           |
